...
@section('metas')
	...
	<meta name="msapplication-TileImage" content="https://milcarteles.com.ar/storage/{{ $imagen_url }}">
	<!-- fb & Whatsapp -->
	...
	<!-- Image to display -->
	<meta property="og:image" content="https://milcarteles.com.ar/storage/{{ $imagen_url }}">
	...
	<meta property="og:url" content="https://milcarteles.com.ar/{{ $negocio->url }}/producto/{{ $producto->codigo }}/{{ $imagen_id }}">
@endsection
