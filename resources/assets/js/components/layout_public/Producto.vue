...
<!--  		<div class="flex flex-item-center flex-content-center p-t-5">
        ...
        <layout-cabecera v-bind:negocio="negocio" :query="query"></layout-cabecera>
 		<div v-if="mostrarDetalleProducto">
			...
			<!--   -->
			<div class="flex flex-direction-column w-10/12 p-10 margen-auto sombra-box no-display-m no-display-s no-display-sx m-t-20" style="border-radius: 15px; background: white; box-shadow: 0px 0px 20px 5px #ddd;" >
...
<!-- 		<div class="p-5" style="background: #eee;">
		...
		<div class="m-t-15">
			<div class="flex flex-item-center flex-content-center  my-10">
...
<script>
    ...
    export default {
        props:['negocio', 'producto','imagen_id', 'query'],
		components: {
			VueLazyLoad,
		    LightBox,
		  },
