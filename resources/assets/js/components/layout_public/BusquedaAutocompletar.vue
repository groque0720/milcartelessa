 ...
 <div style="position:relative" class="ancho-sx-95 ancho-s-90 ancho-m-70 ancho-l-60 ancho-lg-50">
 	<div class="flex flex-item-center flex-space-between mt-2 p-2 zona-buscador ring-green-600 ring-1" :class="{ 'zona-buscador-items': items_filter.length }" style="background: #eee; ">
 		<div class="ancho-100">
<!--  			<form>
